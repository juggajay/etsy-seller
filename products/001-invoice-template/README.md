# Product 001: Auto-Calculate Invoice Template

4-page fillable invoice template with auto-calculating totals.
...
## Key Differentiator
Auto-calculating fields — only 20-30% of Etsy invoice templates have this.
...
## Status
- Product: BUILT
- Listing: 80% done (needs manual file upload + publish)
